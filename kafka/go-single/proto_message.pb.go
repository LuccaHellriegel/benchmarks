...
type ProtoMessage struct {
	...
	SomeId      string            `protobuf:"bytes,3,opt,name=some_id,json=someId,proto3" json:"some_id,omitempty"`
...
func (x *ProtoMessage) GetMessageType() string {
	if x != nil {
...
func (x *ProtoMessage) GetSomeId() string {
	if x != nil {
		return x.SomeId
	}
	return ""
...
func (x *ProtoMessage) GetHeaders() map[string]string {
	if x != nil {
		return x.Headers
	}
	return nil
...
var file_proto_message_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0xdb, 0x01, 0x0a, 0x0c,
	0x50, 0x72, 0x6f, 0x74, 0x6f, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x21, 0x0a, 0x0c,
	...
	0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x73, 0x6f, 0x6d,
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x6f, 0x6d, 0x65,
	0x49, 0x64, 0x12, 0x39, 0x0a, 0x07, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x04, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x10, 0x5a, 0x0e, 0x67, 0x6f, 0x2d,
	0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x2f, 0x6d, 0x61, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_proto_message_proto_goTypes = []interface{}{
	(*ProtoMessage)(nil), // 0: main.ProtoMessage
	nil,                  // 1: main.ProtoMessage.HeadersEntry
}
var file_proto_message_proto_depIdxs = []int32{
	1, // 0: main.ProtoMessage.headers:type_name -> main.ProtoMessage.HeadersEntry
